    ...
    return (
        ...
        >
            ...
            <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-3">CERTIFICATIONS</h2>
            ...
            <ol className="space-y-6 max-w-4xl mx-auto">
                {certifications.map((cert, index) => (
                    <li
                        key={cert.id}
                        className="group flex gap-5 items-start pb-6 border-b border-slate-200 dark:border-gray-800/50 hover:border-purple-500/30 transition-colors duration-300 last:border-b-0"
                    >
                        {/* Number Circle */}
                        ...
                        <div className="flex-1 min-w-0 py-1">
                            ...
                            <div className="flex items-baseline gap-3 flex-wrap mb-2">
                                <button
                                    ...
                                    className="text-lg font-bold text-slate-900 dark:text-white hover:text-purple-600 dark:hover:text-purple-300 cursor-pointer transition group-hover:text-purple-600 dark:group-hover:text-purple-300 duration-300 text-left"
                                >
                                    {cert.title}
                                </button>
                                <span className="text-purple-600 dark:text-purple-500 font-semibold text-sm">{cert.organization}</span>
                            </div>

                            {/* Date & Meta */}
                            <div className="flex items-center gap-4 mb-3 text-sm text-slate-600 dark:text-gray-400 flex-wrap">
                                <div className="flex items-center gap-1.5">
                                    <FaCertificate className="text-yellow-500 text-xs" />
                                    <span>{cert.date}</span>
                                </div>
                                {cert.expiryDate && (
                                    <span className="text-slate-500 dark:text-gray-500">• Expires: {cert.expiryDate}</span>
                                )}
                            </div>
                            ...
                            <div className="flex flex-wrap gap-2 mb-3">
                                {cert.skills.slice(0, 5).map((skill, idx) => (
                                    <span
                                        key={idx}
                                        className="bg-purple-500/20 text-purple-700 dark:text-purple-300 text-xs font-medium px-3 py-1 rounded-full border border-purple-500/40 group-hover:border-purple-500/70 group-hover:bg-purple-500/30 transition-all duration-300"
                                    >
                                        {skill}
                                    </span>
                                ))}
                                {cert.skills.length > 5 && (
                                    <span className="text-slate-500 dark:text-gray-500 text-xs px-2 py-1">
                                        +{cert.skills.length - 5}
                                    </span>
                                )}
                            </div>
                            ...
                            <a
                                ...
                                className="inline-flex items-center gap-2 text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-200 font-semibold text-sm transition-colors duration-300"
                            >
                ...
                >
                    ...
                    >
                        ...
                        <div className="p-8">
                            ...
                            {/* Description */}
                            <div className="mb-6">
                                <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-3">About This Certification</h3>
                            ...
                            {/* Skills */}
                            <div className="mb-6">
                                <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-3">Skills Acquired</h3>
                            ...
                            <div className="bg-slate-100 dark:bg-gray-800/50 rounded-xl p-4 mb-6 border border-slate-200 dark:border-gray-700">
                                <h3 className="text-sm font-semibold text-slate-500 dark:text-gray-400 mb-2">Credential Information</h3>
                                <div className="flex flex-col gap-2">
                                    <div>
                                        <span className="text-xs text-slate-500 dark:text-gray-500">Credential ID: </span>
                                        <span className="text-sm font-mono text-slate-900 dark:text-white">{selectedCert.credentialId}</span>
                                    </div>
                                    <div>
                                        <span className="text-xs text-slate-500 dark:text-gray-500">Issued By: </span>
                                        <span className="text-sm text-slate-900 dark:text-white">{selectedCert.organization}</span>
                                    </div>
                                </div>
                            </div>
