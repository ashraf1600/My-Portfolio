...
const Education = () => {
  ...
  return (
    <section
      id="education"
      className="py-24 px-[5vw] md:px-[8vw] lg:px-[10vw] font-sans bg-gradient-to-b from-slate-100 via-white to-slate-100 dark:from-gray-900 dark:via-[#0a0118] dark:to-gray-900 relative overflow-hidden"
    >
      {/* Background elements */}
      ...
      {Object.entries(groupedEducation).map(([type, entries]) => (
        <div key={type} className="mb-20">
          ...
          <div className="flex justify-center mb-16">
            <div className="inline-flex items-center gap-3 bg-gradient-to-r from-purple-500/10 to-pink-500/10 dark:from-purple-900/40 dark:to-pink-900/40 border border-purple-500/30 rounded-full px-6 py-3 backdrop-blur-sm">
              <div className="w-2 h-2 bg-purple-500 dark:bg-purple-400 rounded-full animate-pulse"></div>
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white">{type}</h3>
                ...
                <div key={edu.id} className="relative mb-12 lg:mb-20">
                  ...
                  <div className="absolute left-1/2 top-8 transform -translate-x-1/2 z-20 hidden lg:block">
                    <div className="relative">
                      <div className="w-20 h-20 rounded-full bg-gradient-to-br from-purple-500 via-pink-500 to-purple-600 p-1.5 shadow-2xl shadow-purple-500/50">
                        <div className="w-full h-full rounded-full bg-white dark:bg-[#0a0118] p-2 flex items-center justify-center overflow-hidden">
                          <img
                            src={edu.img}
                            alt={edu.school}
                  ...
                  <div className={`lg:w-1/2 ${isLeft ? 'lg:pr-16' : 'lg:ml-auto lg:pl-16'}`}>
                    <div className="group relative">
                      ...
                      {/* Main card */}
                      <div className="relative bg-white/95 dark:from-gray-900/95 dark:to-gray-800/95 bg-gradient-to-br backdrop-blur-xl rounded-2xl border border-slate-200 dark:border-purple-500/20 shadow-2xl overflow-hidden transform transition-all duration-300 hover:-translate-y-2 hover:shadow-purple-500/30">
                        {/* Card header with school logo */}
                        <div className="relative bg-gradient-to-r from-purple-500/10 to-pink-500/10 dark:from-purple-900/30 dark:to-pink-900/30 p-6 border-b border-purple-500/20">
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2 leading-tight group-hover:text-purple-600 dark:group-hover:text-purple-300 transition">
                                {edu.degree}
                              </h3>
                        ...
                        <div className="p-6">
                          ...
                          {edu.grade && (
                            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-yellow-500/10 to-yellow-600/10 border border-yellow-500/30 rounded-full px-4 py-2 mb-4">
                              ...
                              <span className="text-yellow-600 dark:text-yellow-400 font-bold text-sm">Grade: {edu.grade}</span>
                            </div>
                          )}
